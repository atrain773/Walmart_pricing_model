...
# Initialize the plot
plt.figure(figsize=(12, len(models) * 6))  # Adjust figure size based on the number of categories

# Plot coefficients for each category
for i, (category, model) in enumerate(models.items()):
    ...
    plt.bar(coeff_names, coefficients, color='skyblue', alpha=0.8)
